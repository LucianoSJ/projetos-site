    ...
    class Caixa {
        ...
        public function listaVendedor() {
            try {
                ...
                echo "Erro ao acessar Vendedor: ", $msg->getMessage();
            }
        }
        ...
        public function InserirCaixa($nome, $telefone, $limite, $cpf, $rg, $endereco, $nascimento) {
            try {
        ...
        public function buscasCaixa($id){
            try {
        ...
        public function atualizarCaixa($id, $nome, $telefone, $limite_cretito, $cpf, $rg, $endereco, $data_nascimento) {
            try {
